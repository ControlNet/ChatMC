...
public final class ChatMCAePartRegistries {
    private static final DeferredRegister<Item> PARTS = DeferredRegister.create(ChatMCAe.MOD_ID, Registries.ITEM);
    private static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(ChatMCAe.MOD_ID, Registries.CREATIVE_MODE_TAB);
