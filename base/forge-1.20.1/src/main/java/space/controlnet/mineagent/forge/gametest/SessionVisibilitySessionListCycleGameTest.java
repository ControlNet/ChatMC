...
public final class SessionVisibilitySessionListCycleGameTest {
    private SessionVisibilitySessionListCycleGameTest() {
    }
    ...
    public static void sessionVisibilitySessionListUpdateCycle(GameTestHelper helper) {
        GameTestRuntimeLease.runWhenAvailable(helper,
                () -> SessionLifecycleGameTestScenarios.sessionVisibilitySessionListUpdateCycle(
                        helper,
                        SessionVisibilitySessionListCycleGameTest::createPlayer
                ));
    }
