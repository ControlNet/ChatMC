...
public final class DeleteLastActiveSessionFallbackGameTest {
    private DeleteLastActiveSessionFallbackGameTest() {
    }
    ...
    public static void deleteLastActiveSessionFallbackCreatesNewSession(GameTestHelper helper) {
        GameTestRuntimeLease.runWhenAvailable(helper,
                () -> SessionLifecycleGameTestScenarios.deleteLastActiveSessionFallbackCreatesNewSession(
                        helper,
                        DeleteLastActiveSessionFallbackGameTest::createPlayer
                ));
    }
