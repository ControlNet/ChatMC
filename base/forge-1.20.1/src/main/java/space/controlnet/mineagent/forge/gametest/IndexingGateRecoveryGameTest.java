...
public final class IndexingGateRecoveryGameTest {
    ...
    private static void indexingGateRecoveryAcrossReloadInternal(GameTestHelper helper) {
        ...
        try {
            ...
            requireTrue("task7/setup/index-ready-confirmed", MineAgent.RECIPE_INDEX.isReady());
            ...
            requireTrue("task7/rebuild/index-not-ready-while-pending", !MineAgent.RECIPE_INDEX.isReady());
            ...
            requireTrue("task7/rebuild/index-ready-after-release", MineAgent.RECIPE_INDEX.isReady());
            ...
            requireTrue("task7/recovery/request-path-reopened", MineAgentNetwork.SESSIONS.tryStartThinking(sessionId));
            ...
            requireTrue("task7/reload/index-ready-after-completion", MineAgent.RECIPE_INDEX.isReady());
