...
import space.controlnet.mineagent.core.tools.ToolArgs;
...
public final class McToolProvider implements ToolProvider {
    ...
    private static final List<AgentTool> TOOLS = List.of(
            new SimpleTool(
                    ...
                    payload -> renderWithSummary("ui.mineagent.tool.mc.find_recipes",
            ...
            new SimpleTool(
                    ...
                    payload -> renderWithSummary("ui.mineagent.tool.mc.find_usage",
                            List.of(formatItemTarget(payload)), payload)
            ),
            new SimpleTool(
                    "response",
    ...
    private static ToolResult handleMcFindRecipes(ToolCall call) {
        ...
        RecipeSearchResult result = MineAgent.RECIPE_INDEX.findByOutput(args.itemId(), Optional.ofNullable(args.pageToken()), args.limit());
    ...
    private static ToolResult handleMcFindUsage(ToolCall call) {
        ...
        RecipeSearchResult result = MineAgent.RECIPE_INDEX.findByIngredient(args.itemId(), Optional.ofNullable(args.pageToken()), args.limit());
        return ToolResult.ok(GSON.toJson(result));
    }
    ...
    private static String formatItemTarget(space.controlnet.mineagent.core.tools.ToolPayload payload) {
