package space.controlnet.mineagent.common.menu;
...
public final class AiTerminalMenu extends AbstractContainerMenu {
    ...
    private final Optional<TerminalHost> host;
    ...
    public AiTerminalMenu(int containerId, Inventory inventory, TerminalHost host, BlockPos pos, Direction side) {
        super(MineAgentRegistries.AI_TERMINAL_MENU.get(), containerId);
        this.pos = pos;
    ...
    public Optional<TerminalHost> getHost() {
        return host;
    }
    ...
    public void removed(Player player) {
        ...
        if (player instanceof net.minecraft.server.level.ServerPlayer serverPlayer) {
            space.controlnet.mineagent.common.MineAgentNetwork.onTerminalClosed(serverPlayer);
        }
    }
