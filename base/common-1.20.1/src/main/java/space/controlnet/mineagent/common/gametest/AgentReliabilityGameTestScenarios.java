...
public final class AgentReliabilityGameTestScenarios {
    ...
    private static final class ControlledToolProvider implements ToolProvider {
        ...
        @Override
        public space.controlnet.mineagent.core.tools.ToolOutcome execute(
                Optional<space.controlnet.mineagent.core.terminal.TerminalContext> terminal,
                ToolCall call,
                boolean approved
        ) {
            executeCount.incrementAndGet();
            return space.controlnet.mineagent.core.tools.ToolOutcome.result(ToolResult.ok("{\"ok\":true}"));
        }
    }
