package space.controlnet.chatmc.common.menu;
...
public final class AiTerminalMenu extends AbstractContainerMenu {
    ...
    public AiTerminalMenu(int containerId, Inventory inventory, TerminalHost host, BlockPos pos, Direction side) {
        super(ChatMCRegistries.AI_TERMINAL_MENU.get(), containerId);
        this.pos = pos;
    ...
    public void removed(Player player) {
        ...
        if (player instanceof net.minecraft.server.level.ServerPlayer serverPlayer) {
            space.controlnet.chatmc.common.ChatMCNetwork.onTerminalClosed(serverPlayer);
        }
    }
