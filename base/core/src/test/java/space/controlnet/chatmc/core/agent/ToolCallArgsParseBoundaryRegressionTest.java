...
public final class ToolCallArgsParseBoundaryRegressionTest {
    ...
    void task15_parserIntegration_contractsRetainBoundaryValidationAndMapping() {
        String reasoningService = readSource(
                "base/core/src/main/java/space/controlnet/chatmc/core/agent/AgentReasoningService.java"
        );
        assertContains(
        ...
        String langChainParser = readSource(
                "base/core/src/main/java/space/controlnet/chatmc/core/agent/LangChainToolCallParser.java"
        );
        assertContains(
