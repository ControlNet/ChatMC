...
public final class McpPromptToolOrderRegressionTest {
    ...
    void task9e2e_registrySortedNamespacedSnapshot_feedsDeterministicAgentLoopPromptOrder() {
        String agentLoopSource = readSource("base/core/src/main/java/space/controlnet/chatmc/core/agent/AgentLoop.java");
        String toolRegistrySource = readSource("base/common-1.20.1/src/main/java/space/controlnet/chatmc/common/tools/ToolRegistry.java");
