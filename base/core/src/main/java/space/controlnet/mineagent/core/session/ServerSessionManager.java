...
public final class ServerSessionManager {
    private static final int MAX_MESSAGES_PER_SESSION = intProperty("mineagent.maxMessagesPerSession", 400);
    private static final int MAX_DECISIONS_PER_SESSION = intProperty("mineagent.maxDecisionsPerSession", 200);
    private static final int MAX_SESSIONS_TOTAL = intProperty("mineagent.maxSessionsTotal", 200);
    private static final int MAX_MESSAGE_LENGTH = intProperty("mineagent.maxMessageLength", 65536);
